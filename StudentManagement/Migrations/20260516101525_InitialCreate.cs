        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectId = table.Column<int>(type: "int", nullable: false),
                    ClassSectionId = table.Column<int>(type: "int", nullable: false),
                    PrelimGrade = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    ...
                    OverallGrade = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Remarks = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_ClassSections_ClassSectionId",
                        column: x => x.ClassSectionId,
                        principalTable: "ClassSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_StudentId_ClassSectionId_Date",
                table: "Attendances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grades_ClassSectionId",
                table: "Grades",
                column: "ClassSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_Grades_StudentId_ClassSectionId_SubjectId",
                table: "Grades",
                columns: new[] { "StudentId", "ClassSectionId", "SubjectId" },
                unique: true);
